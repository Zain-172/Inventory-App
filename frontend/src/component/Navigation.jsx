...
const Navigation = () => {
  ...
  return (
    <nav
      className={`text-white flex flex-col absolute top-0 left-0 px-[10px] h-full ${
    ...
    >
      <button
        onClick={toggleMenu}
        className="absolute flex flex-col items-center gap-1 top-2 right-0 w-[70px]"
      >
      ...
      <ul className="flex flex-col gap-4" style={{ margin: "6rem 0" }}>
        <li>
          ...
          >
            <FaThLarge style={{ minWidth: "50px", fontSize: "2rem" }} />
        ...
        <li>
          <Link
            ...
            href="/admin/package"
          >
            <FaPaperPlane style={{ minWidth: "50px", fontSize: "2rem" }} />
        ...
        <li>
          <Link
            ...
            href="/admin/stat"
          >
            <FaChartPie style={{ minWidth: "50px", fontSize: "2rem" }} />
        ...
        <li>
          <Link
            ...
            href="/admin/payment"
          >
            <FaWallet style={{ minWidth: "50px", fontSize: "2rem" }} />
        ...
        <li>
          <Link
            ...
            href="/admin/client"
          >
            <FaUserCircle style={{ minWidth: "50px", fontSize: "2rem" }} />
        ...
        <li>
          <Link
            ...
            href="/admin/review"
          >
            <FaStar style={{ minWidth: "50px", fontSize: "2rem" }} />
        ...
        <li>
          <Link
            ...
            href="/"
          >
            <FaArrowLeft style={{ minWidth: "50px", fontSize: "2rem" }} />
            <p className="text-sm font-bold">Back</p>
          </Link>
        </li>
      </ul>
      <button className="flex gap-4 absolute bottom-2">
        <FaDoorClosed style={{ fontSize: "2rem", minWidth: "50px" }} />
