      ...
      {open && (
        ...
        >
          ...
          <Motion.div
            ...
            className="relative w-full max-w-[370px] p-6 bg-white dark:bg-neutral-900 border-white/40 border shadow-white/5 rounded-2xl shadow-md z-10"
          >
            {/* Title */}
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                onClick={onOk}
                className="px-4 py-2 rounded-xl bg-green-600 min-w-20 text-white font-semibold hover:bg-green-800 transition-colors"
              >
                {okLabel}
              </button>
            </div>
